...
public class Tela2 extends javax.swing.JFrame {
    ...
    private Fabrica fs = new FabricaSorvete();
    ...
    private void alterarValorSundae(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarValorSundae
        ...
        tfTotal.setText(String.valueOf(fs.criarSorvete("sundae").valor()));
        setSorvete(fs.criarSorvete("sundae"));
    ...
    private void alterarValorCasquinha(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarValorCasquinha
        // TODO add your handling code here:
        tfTotal.setText(String.valueOf(fs.criarSorvete("casquinha").valor()));
        setSorvete(fs.criarSorvete("casquinha"));
    ...
    private void alterarValorTradicional(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarValorTradicional
        // TODO add your handling code here:
        tfTotal.setText(String.valueOf(fs.criarSorvete("tradicional").valor()));
        setSorvete(fs.criarSorvete("tradicional"));
    ...
    private void alterarValorGranulado(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarValorGranulado
        // TODO add your handling code here:
        if (cbGranulado.isSelected()) {
            GranuladoDecorator g = new GranuladoDecorator(getSorvete());
            tfTotal.setText(String.valueOf(g.valor()));
        } else {
            GranuladoDecorator g = new GranuladoDecorator(getSorvete());
            Double valor = Double.parseDouble(tfTotal.getText()) - g.valor() + getSorvete().valor();
    ...
    private void alterarValorMel(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarValorMel
        // TODO add your handling code here:
        if (cbMel.isSelected()) {
            MelDecorator m = new MelDecorator(getSorvete());
            tfTotal.setText(String.valueOf(m.valor()));
        } else {
            MelDecorator m = new MelDecorator(getSorvete());
            Double valor = Double.parseDouble(tfTotal.getText()) - m.valor() + getSorvete().valor();
            tfTotal.setText(String.valueOf(this.sorvete.valor()));
        }
    ...
    private void alterarValorMM(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarValorMM
        // TODO add your handling code here:
        if (cbMM.isSelected()) {
            MMDecorator mm = new MMDecorator(getSorvete());
            tfTotal.setText(String.valueOf(mm.valor()));
            total = total + mm.valor();
        } else {
            MMDecorator mm = new MMDecorator(getSorvete());
            Double valor = Double.parseDouble(tfTotal.getText()) - mm.valor() + getSorvete().valor();
            tfTotal.setText(String.valueOf(this.sorvete.valor()));
        }
